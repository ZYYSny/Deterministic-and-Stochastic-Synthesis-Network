#ifndef CAFFE_CHANNEL_TRANSFORM_LAYER_HPP_
#define CAFFE_CHANNEL_TRANSFORM_LAYER_HPP_
...
class ChannelTransformLayer : public Layer<Dtype> {
 public:
  explicit ChannelTransformLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "ChannelTransform"; }
...
#endif  // CAFFE_CHANNEL_TRANSFORM_LAYER_HPP_
