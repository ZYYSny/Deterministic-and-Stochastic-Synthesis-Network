#ifndef CAFFE_PIXELWISE_GRAMMATRIX_LAYER_HPP_
#define CAFFE_PIXELWISE_GRAMMATRIX_LAYER_HPP_
...
class PixelwiseGrammatrixLayer: public LossLayer<Dtype> {
 public:
  explicit PixelwiseGrammatrixLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "PixelwiseGrammatrix"; }
  // PixelwiseGrammatrix
...
#endif  // CAFFE_PIXELWISE_GRAMMATRIX_LAYER_HPP_